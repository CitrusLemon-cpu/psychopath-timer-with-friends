...
['#timer-start', '#timer-end'].forEach((selector) => $(selector).addEventListener('click', (event) => { if (typeof event.currentTarget.showPicker === 'function') event.currentTarget.showPicker(); }));
