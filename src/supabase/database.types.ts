...
export interface Database {
  public: {
    ...
    Functions: {
      ...
      create_countdown_v2: { Args: { target_scope: TimerScope; countdown_name: string; seconds: number; target_room_id: string; policy: TimerControlPolicy; participant_ids: string[]; scheduled_for: string | null; countdown_color: string; fixed_end: boolean }; Returns: CountdownRow }
      create_and_start_countdown_v2: { Args: { target_scope: TimerScope; countdown_name: string; seconds: number; target_room_id: string; policy: TimerControlPolicy; participant_ids: string[]; countdown_color: string; fixed_end: boolean }; Returns: CountdownRow }
      ...
      update_countdown_v2: { Args: { target_countdown_id: string; target_scope: TimerScope; countdown_name: string; seconds: number; countdown_color: string; policy: TimerControlPolicy; participant_ids: string[]; scheduled_for: string | null; start_immediately: boolean; fixed_end: boolean }; Returns: CountdownRow }
